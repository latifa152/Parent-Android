...
public class CurrentLocation extends AppCompatActivity implements OnMapReadyCallback {
    ...
    DatabaseReference mReference,newReference;
    String key;
    Marker mUserMarker;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mReference = mFirebaseDatabase.getReference( Common.Child_information_tb1 );
        mReference.addValueEventListener( new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.child( key ).exists()){

                    newReference = mReference.child( key ).child( "Location" ).child( "l" );
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    latitude = (double) dataSnapshot.child( "0" ).getValue();
                    longitude= (double) dataSnapshot.child( "1" ).getValue();
                ...
                public void onCancelled(@NonNull DatabaseError databaseError) {
                    ...
                    Toasty.error( CurrentLocation.this," Yor child location is not available right now please check some time later",Toast.LENGTH_LONG ).show();
                }
            }
